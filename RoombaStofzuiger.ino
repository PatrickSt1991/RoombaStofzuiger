...
const char *mqtt_client_name = "RoombaStofzuiger"; // Client connections can't have the same connection name
...
#define SERIAL_TX     D2  // pin for SoftwareSerial TX
...
void setup_wifi() 
{
  WiFi.hostname("RoombaStofzuiger");
